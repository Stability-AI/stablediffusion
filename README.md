...
- New models fine-tuned on 2.0, on a less restrictive NSFW filtering of the [LAION-5B](https://laion.ai/blog/laion-5b/) dataset, after reflecting on, and examining the assumptions made in 2.0, and consulting with the authors of [LAION-5B](https://openreview.net/forum?id=M3Y74vmsMcY).
